...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minimumTokenBalanceForDividends = 17600000 * (10**9); // user must hold 17.6m token
...
contract KILLDOGE is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "Kill Doge";
    string constant _symbol = "KILLDOGE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 88000000000 * (10 ** _decimals);
